...
<br>
파이썬 파일 실행 모듈
<pre><code>pip install config oauth2 pandas numpy konlpy platform soynlp</code></pre><br>
파이썬 파일 exe 변환<br>
...
<pre><code>pyinstaller -i=project_icon.ico --onefile spst_analy_crawl.py --hidden-import=pandas --hidden-import=config --hidden-import=numpy --hidden-import=konlpy --hidden-import=oauth2 --hidden-import=soynlp --hidden-import=sklearn.utils._cython_blas --add-data konlpy;konlpy</code></pre>
<br>
